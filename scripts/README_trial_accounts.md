...
|---------|------------|----------|------------|------------|
| アカウント1 | `trial1@example.com` | （管理者が設定） | 5日間 | 15回 |
| アカウント2 | `trial2@example.com` | （管理者が設定） | 5日間 | 15回 |
| アカウント3 | `trial3@example.com` | （管理者が設定） | 5日間 | 15回 |

> **注意**: パスワードは大文字・小文字・数字・記号を含む8文字以上で設定してください。
> セキュリティのため、パスワードはドキュメントに記載せず、安全な場所で管理してください。
...
2. **各アカウントを作成**
   ...
   - 「**Create user**」をクリック
   - 同様に`trial2@example.com`と`trial3@example.com`も作成（各アカウントに異なるパスワードを設定）
