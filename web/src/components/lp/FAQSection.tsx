...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      '内容・表現・構成の3軸で答案を評価し、点数・減点理由・改善ポイント・書き直し例を返します。重要な答案や入試直前の判断では、先生や保護者が最終確認してください。',
  },
  {
    question: 'どのAIモデルを使っていますか？',
    answer:
      'Googleの最新モデル「Gemini 3.8 Flash」を採用しています（2026年9月時点）。応答の速さと推論の細かさを両立したモデルで、減点理由や書き直し例を、より短い待ち時間で、より精細に返せるようになりました。モデルは検証のうえ、今後も順次更新していきます。',
  },
  {
  ...
  },
  {
    ...
    answer:
      'いいえ。初回5回の無料トライアルにクレジットカード登録は不要です。有料プランへの切り替えはご自身で明示的にお手続きいただく必要があります。',
  },
  {
